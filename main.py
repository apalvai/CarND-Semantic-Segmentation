...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Layer 3
    layer3_decode = tf.layers.conv2d_transpose(layer4_output, num_classes, 16, strides=(8, 8), padding="same",
                                               kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
...
def run():
    ...
    with tf.Session() as sess:
        ...
        nn_last_layer = layers(w_layer3, w_layer4, w_layer7, num_classes)
        logits, train_op, loss = optimize(nn_last_layer, correct_label, learning_rate, num_classes)

        # TODO: Train NN using the train_nn function
        train_nn(sess, epochs, batch_size, get_batches_fn, train_op, loss, w_input, correct_label, keep_prob, learning_rate)

        # TODO: Save inference data using helper.save_inference_samples
        helper.save_inference_samples(runs_dir, data_dir, sess, image_shape, logits, keep_prob, w_input)
